...
import static com.neuron.genieapp.Constants.HTML_POSTFIX;
import static com.neuron.genieapp.Constants.HTTP_PREFIX;
...
//            saveHTML(fileName, currentURL, directory);
    ...
    public String addPostfixIfNotExist(String page){
